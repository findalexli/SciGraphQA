...
with_abstract_graph_derived_question_forty_to_seventy_percent_train = dataset_non_empty_mention.map(return_palm, num_proc=16)
with_abstract_graph_derived_question_forty_to_seventy_percent_train.save_to_disk('with_abstract_graph_derived_question_forty_to_seventy_percent_train')
